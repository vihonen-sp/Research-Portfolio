...
## Short summary:
I am a theoretical physicist specializing in neutrino phenomenology. My reserach interests center on neutrinos and their properties. In this document, I describe briefly the scope of research that I have been doing in my most recent works.

## Atmospheric neutrinos at ESSnuSB
Atmospheric neutrinos are neutrinos that are created in cosmic-ray interactions inside the Earth's atmosphere. The European Spallation Source neutrino Super-Beam (ESSnuSB) experiment aims to construct a large-scale neutrino detector with capability of detecting significant numbers of atmospheric neutrinos. In my recent role at KTH Royal Institute of Technology, I studied the experiment's ability to detect atmospheric neutrinos in its far detector and provided sensitivity studies for standard and non-standard physics. My work was part of the ESSnuSB+ project, which is co-funded by the European Union during 2023-2026. More information can be found in https://essnusb.eu/.
